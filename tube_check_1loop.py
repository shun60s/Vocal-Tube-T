...
if __name__ == '__main__':
    ...
    #
    #from T_three_tube import *
    from oneloop_four_tube import *
    
    """
    # insatnce T three tube model example
    tube  =  Class_T_ThreeTube(L1_a, L2_a, L3_o, A1_a, A2_a, A3_o, sampling_rate=48000*4)
    Class_Tube_Check(tube)
    
    # insatnce T three tube model example, A3=0
    tube  =  Class_T_ThreeTube(L1_a, L2_a, L3_o, A1_a, A2_a, 0.0, sampling_rate=48000*4)
    Class_Tube_Check(tube)
    """
    
    # insatnce 1loop four tube model example
    L1=4.0
    L4=1.0
    L2=10
    A1=1
    ...
    a_ratio=1.0
    l_ratio=1.0
    tube  =  Class_1loop_FourTube(L1, L2,  L2*l_ratio, L4, A1, A2, A2*a_ratio, A4, sampling_rate=48000*4)
    Class_Tube_Check(tube)
